...
\begin{document}
	...
	\begin{enumerate}
		...
		b $\rightarrow$ Campana | c $\rightarrow$ Cónica | x $\rightarrow$ Convexa | f $\rightarrow$ Plana | k $\rightarrow$ Con mamelón (protuberancia) | s $\rightarrow$ Deprimido
		...
		c $\rightarrow$ Cortina | e $\rightarrow$ Sutil | f $\rightarrow$ Acampanado | l $\rightarrow$ Grande | n $\rightarrow$ No hay anillo | p $\rightarrow$ Péndulo | s $\rightarrow$ Envainado | z $\rightarrow$ En zona
		
		\item Color de la esporada
		
		k $\rightarrow$ Negro | n $\rightarrow$ Marrón | b $\rightarrow$ Ante/Crema | h $\rightarrow$ Chocolate | r $\rightarrow$ Verde | o $\rightarrow$ Naranja | u $\rightarrow$ Morado | w $\rightarrow$ Blanco | y $\rightarrow$ Amarillo
